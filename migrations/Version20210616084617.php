...
final class Version20210616084617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lig_com (id INT AUTO_INCREMENT NOT NULL, id_produit_id INT NOT NULL, id_commande_id INT NOT NULL, qte_produit INT NOT NULL, remise NUMERIC(10, 2) NOT NULL, com_sous_tot NUMERIC(10, 2) NOT NULL, INDEX IDX_DD0A0C20AABEFE2C (id_produit_id), INDEX IDX_DD0A0C209AF8E3A3 (id_commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, id_pays_id INT NOT NULL, id_role_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, code_postal VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, date_naissance DATETIME DEFAULT NULL, INDEX IDX_497B315E7879EB34 (id_pays_id), INDEX IDX_497B315E89E8BDC (id_role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD CONSTRAINT FK_497B315E89E8BDC FOREIGN KEY (id_role_id) REFERENCES roles (id)');
    }
