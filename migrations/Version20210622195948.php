 ...
 */
final class Version20210622195948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateurs ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', ADD password VARCHAR(255) NOT NULL, DROP id_role_id, DROP id_pays_id, DROP mot_de_passe, DROP telephone, DROP code_postal, DROP ville, DROP adresse, DROP date_naissance, CHANGE mail mail VARCHAR(180) NOT NULL');
