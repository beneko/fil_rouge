 ...
 */
final class Version20210623135607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories (id INT AUTO_INCREMENT NOT NULL, id_cat_id INT DEFAULT NULL, nom_cat VARCHAR(255) NOT NULL, libelle_cat VARCHAR(255) DEFAULT NULL, image_cat VARCHAR(50) DEFAULT NULL, INDEX IDX_3AF34668C09A1CAE (id_cat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, id_addr_livr_id INT NOT NULL, id_mode_livr_id INT NOT NULL, id_reduc_id INT DEFAULT NULL, statut VARCHAR(255) NOT NULL, date_com DATETIME NOT NULL, total_commande NUMERIC(10, 2) NOT NULL, INDEX IDX_35D4282CCCF8C1AA (id_addr_livr_id), INDEX IDX_35D4282C227224D7 (id_mode_livr_id), INDEX IDX_35D4282C10C6A06F (id_reduc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lig_com (id INT AUTO_INCREMENT NOT NULL, id_produit_id INT NOT NULL, id_commande_id INT NOT NULL, ref_commande_id INT NOT NULL, qte_produit INT NOT NULL, remise NUMERIC(10, 2) NOT NULL, com_sous_tot NUMERIC(10, 2) NOT NULL, INDEX IDX_DD0A0C20AABEFE2C (id_produit_id), INDEX IDX_DD0A0C209AF8E3A3 (id_commande_id), INDEX IDX_DD0A0C2078E3D6D8 (ref_commande_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, id_marque_id INT NOT NULL, categorie_id INT DEFAULT NULL, nom_produit VARCHAR(255) NOT NULL, libelle_produit VARCHAR(255) DEFAULT NULL, prix_produit NUMERIC(10, 2) NOT NULL, stock_produit INT NOT NULL, pds_produit NUMERIC(10, 2) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_BE2DDF8CC8120595 (id_marque_id), INDEX IDX_BE2DDF8CBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, mail VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_497B315E5126AC48 (mail), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
