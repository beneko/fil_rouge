...
class UtilisateursController extends AbstractController
{
    ...
    /**
     * @Route("/{idUtilisateur}", name="utilisateurs_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idUtilisateur}/edit", name="utilisateurs_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idUtilisateur}", name="utilisateurs_delete", methods={"POST"})
     */
